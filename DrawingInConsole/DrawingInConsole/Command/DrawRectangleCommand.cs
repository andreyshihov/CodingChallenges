...
{
	public class DrawRectangleCommand : BaseCommand
	{
		...
		public DrawRectangleCommand(string args) : base(args)
		{
		...
		public override void Do(ConsoleCanvas canvas, MatrixToolFactory toolsFactory)
		{
			...
			var rectangleDrawer = toolsFactory.CreateRectangleTool(x1, y1, x2, y2);

			canvas.Draw(rectangleDrawer);
			canvas.Render();
		}
	}
}
